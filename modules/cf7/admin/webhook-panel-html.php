...
?>
    <p style="background: #FF4A00; display: block; color: #FFFFFF; padding: 10px 15px; margin: 10px 0 20px;">
        <strong style="margin-right: 5px;"><?php _e( 'Give your support!', 'cf7-to-actionnetwork' ); ?></strong>
        <?php
            printf(
                __( 'You can %s or %s.', 'cf7-to-actionnetwork' ),
                '<a href="https://www.paypal.com/donate?campaign_id=9AA82JCSNWNFS" target="_blank" style="color: #FFFFFF;">' . __( 'make a donation', 'cf7-to-actionnetwork' ) . '</a>',
                '<a href="https://wordpress.org/support/plugin/cf7-to-actionnetwork/reviews/#new-post" target="_blank" style="color: #FFFFFF;">' . __( 'leave a review', 'cf7-to-actionnetwork' ) . '</a>'
            );
        ?>
    </p>
<?php endif; ?>
...
<h2>
    <?php _e( 'Webhook', 'cf7-to-actionnetwork' ) ?>
</h2>

<fieldset>
    <legend>
        <?php _e( 'In these options you can activate or deactivate Webhook integration.', 'cf7-to-actionnetwork' ); ?>
        <br>
        <?php _e( 'To integrate you should insert your webhook URL below. For example, into actionnetwork you can create a trigger using "Webhooks" app and choose "Catch Hook" option.', 'cf7-to-actionnetwork' ); ?>
    </legend>
    ...
    <table class="form-table">
        <tbody>
                ...
                <td>
                    <p>
                        <label for="ctz-webhook-activate">
                            ...
                            <?php _e( 'Send to Webhook', 'cf7-to-actionnetwork' ) ?>
                        </label>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label>
                        <?php _e( 'Webhook URL', 'cf7-to-actionnetwork' ) ?>
                    </label>
                </th>
                <td>
                    <p>
            ...
            <tr>
                <th scope="row">
                    <label>
                        <?php _e( 'Send Mail', 'cf7-to-actionnetwork' ) ?>
                    </label>
                </th>
                <td>
                    <p>
...
<fieldset>
    ...
    <div style="margin: 20px 0;">
        ...
        <p class="description"><?php
            printf(
                __( 'Insert Special Tags like in mail body: %s', 'cf7-to-actionnetwork' ),
            ...
            printf(
                __( 'Or add a second word to pass as key to Webhook: %s', 'cf7-to-actionnetwork' ),
...
<h2>
    <?php _e( 'Custom Headers', 'cf7-to-actionnetwork' ) ?>
</h2>

<fieldset>
    <legend>
        <?php echo _x( 'You can add <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers" target="_blank">HTTP Headers</a> to your webhook request.', 'The URL should point to HTTP Headers documentation in your language.', 'cf7-to-actionnetwork' ); ?>
    </legend>
    ...
    <div style="margin: 20px 0;">
        ...
        <p class="description"><?php
            printf(
                __( 'One header by line, separated by colon. Example: %s', 'cf7-to-actionnetwork' ),
...
<h2>
    <?php _e( 'URL Params', 'cf7-to-actionnetwork' ) ?>
</h2>

<fieldset>
    <legend>
        <?php echo _x( 'You can add URL parameters using <a href="https://contactform7.com/hidden-field/" target="_blank">Hidden Fields</a> with <a href="https://contactform7.com/getting-default-values-from-the-context/" target="_blank">default values</a> in your form.', 'The URL should point to CF7 documentation.', 'cf7-to-actionnetwork' ); ?>
    </legend>

    <div style="margin: 20px 0;">
        <pre style="background: #FFF; border: 1px solid #CCC; padding: 10px; margin: 0;"><?php
            _e( 'To get utm_source: https://example.com/?utm_source=example', 'cf7-to-actionnetwork' );
            echo "\n";
            _e( 'Use this shortcode: [hidden utm_source default:get]', 'cf7-to-actionnetwork' );
        ?></pre>
    </div>
</fieldset>

<h2>
    <?php _e( 'Data sent to Webhook', 'cf7-to-actionnetwork' ) ?>
</h2>

<fieldset>
    <legend>
        <?php _e( 'We will send your form data as below:', 'cf7-to-actionnetwork' ) ?>
    </legend>
    ...
    <div style="margin: 20px 0;">
        ...
        ?></pre>
        <p class="description"><?php
            _e( 'This is just a example of field names and will not reflect data or customizations.', 'cf7-to-actionnetwork' );

            echo '<br>';

            printf(
                __( 'You can change field name with webhook config: %s', 'cf7-to-actionnetwork' ),
